...
export default function Comments({ commentDomRef }) {
  const [hotCommentList, setHotCommentList] = useState([]);
  // const hotCommentList: ['感动天地师徒情', '2D动画新高度', '萌系指数爆表'];
  ...
  // }
  useEffect(() => {
    setHotCommentList(['感动天地师徒情', '2D动画新高度', '萌系指数爆表'])
  }, [])

  return (
    <div className="comments-component-wrapper" ref={commentDomRef}>
      {/*影评*/}
